...
import com.langwing.samocharge._fragment._dynamic._wonderfulLife.spannable.CircleMovementMethod;
import com.langwing.samocharge._fragment._dynamic._wonderfulLife.spannable.SpannableClickable;
...
public class CommentListView extends LinearLayout {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            //textview的默认颜色
            itemColor = typedArray.getColor(R.styleable.PraiseListView_item_color, getResources().getColor(R.color.black_32));
            itemSelectorColor = typedArray.getColor(R.styleable.PraiseListView_item_selector_color, getResources().getColor(R.color.gray_cc));
...
//                                        Toast.makeText(ChargingApplication.application, textStr + " &id = " + id, Toast.LENGTH_SHORT).show();
                                    }
