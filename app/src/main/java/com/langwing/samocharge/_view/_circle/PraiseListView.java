...
public class PraiseListView extends TextView {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            //textview的默认颜色
            itemColor = typedArray.getColor(R.styleable.PraiseListView_item_color, getResources().getColor(R.color.black_64));
    ...
    private SpannableString setImageSpan() {
        ...
        imgSpanText.setSpan(new ImageSpan(ChargingApplication.application, R.drawable.praise, DynamicDrawableSpan.ALIGN_BASELINE),
