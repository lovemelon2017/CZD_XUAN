...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.gray_cc;
    /**
     * 整个textView的背景色
     */
    ...
    public CircleMovementMethod() {
        this.textViewBgColor = ChargingApplication.application.getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = ChargingApplication.application.getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
